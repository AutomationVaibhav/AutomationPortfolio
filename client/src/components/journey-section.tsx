  ...
  const timelineItems = [
    {
      ...
      achievements: [
        ...
        "🏗️ Built robust test scripts using Selenium with Java following Page Object Model architecture",
    ...
    },
    {
      ...
      achievements: [
        ...
        "🛡️ Conducted comprehensive regression testing ensuring core feature stability",
        "🔄 Converted manual test cases into automated scripts improving testing efficiency",
        "⚙️ Contributed to framework enhancements with utility functions and features",
